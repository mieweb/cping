// $Id: cping_common.h,v 1.2 2007/06/03 17:50:16 jasone Exp $
...
short failed_only;		// Added by Jason E.
long  failed_timeout;	// Added by Jason E.
static char SNAPSHOT[] = "s20070202";	// Added by Jason E.
...
case 'f': case 'F': case 'i': case 'w': case 'l': \
case 'S': case 'n': case 'p': case 'q': \
case 'r': case 's': case 'v': case 'L': \
case 't': case 'A': case 'W': case 'B':

#define COMMON_OPTSTR "h?VQ:I:M:aUc:dF:fi:w:l:S:np:qrs:vLt:AW:B"	// Modified by Jason E (added -F option)
